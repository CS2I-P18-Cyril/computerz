/*
    Projet Computerz - Script PostgreSQL
*/

CREATE SCHEMA IF NOT EXISTS computerz;
SET SEARCH_PATH TO computerz;
...
CREATE TABLE IF NOT EXISTS ordinateurs (
    ...
    memoire     INT,
    disque      VARCHAR(30),
    neuf        BOOLEAN        NOT NULL DEFAULT true,
...
CREATE TABLE IF NOT EXISTS configurations (
    id              SERIAL         PRIMARY KEY,
    id_ordinateur   INT            NOT NULL REFERENCES ordinateurs(id),
...
VALUES
    ...
    'Windows 10 Professionnel 64 bits', 'Intel Core i7', 16, 'SSD 512 Go', true, 1199.95,
...
VALUES
    ...
    'Windows 10 Famille 64 bits', 'Intel Core i7', 16, 'SSD 512 Go', true, 1299.95,
    'msi-gf65.png');
...
VALUES
    ...
    'Windows 10 Famille 64 bits', 'Intel Core i5', 8, 'SSD 512 Go', false, 899.95,
...
VALUES
    ...
    'Windows 10 Famille 64 bits', 'AMD Ryzen 5', 8, 'SSD 1 To', true, 699.95,
...
VALUES
    ...
    'Windows 10 Professionnel 64 bits', 'Intel Core i7', 16, 'SSD 512 Go', true, 1249.95,
    'msi-modern-14.png');   
...
VALUES
    ...
    'Windows 10 Famille 64 bits', 'AMD Ryzen 5', 8, 'SSD 512 Go', true, 999.95,
    'asus-a15-tuf.png');        
